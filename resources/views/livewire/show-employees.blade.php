		...
		<div class="d-flex">
			...
			<div class="col-md-8 my-4">
				<div class="row d-flex justify-content-end">
					<div class="col-md-4">
						<button type="button" class="btn btn-success text-white btn-block" href="#" data-toggle="modal" data-target="#newEmploye" aria-hidden="false">
							<span class="btn-inner--icon"><i class="fas fa-user"></i></span>
							<span class="btn-inner--text">Nuevo empleado</span>
						</button>
						<!-- Modal -->
						<div class="modal fade" id="newEmploye" role="dialog" aria-labelledby="newEmploye" aria-hidden="false">
			...
			<tbody class="list">
				...
				<tr>
					...
					<td class="d-flex">
						...
						<form class="form-delete" method="POST" action="{{ route('employe.destroy', $employe->slug) }}">
							@method("delete")
							@csrf
